...
function slippery()
	if _G.modifyPhysics == true then
		workspace.Terrain.CustomPhysicalProperties = PhysicalProperties.new(1,1,1,0, 200)
	end
end
...
while true do
	...
	if mr == 3 then
		...
		local tween2 = game:GetService("TweenService"):Create(game.Workspace["AX+2"].rain_loop, tweenInfo, {Volume = 1})
